function jointProbabiliteGamma=jointProbabilite_QPSK_Gamma(bit_Alice,bit_Bob,ScaleCo,P_T_dBm,C2n) 
    ...
    G_Tx_dB=120;                   %Tx telescope gain(dB)
    G_Tx=10^(G_Tx_dB/10);
    G_Rx_dB=121;                   %Rx telescope gain(dB)
    G_Rx=10^(G_Rx_dB/10);
